function [p_EKF,q_EKF,m_EKF,P_EKF,P_pose_prior,P_pose_posterior]=EKF_quick(N,delta_p,delta_q,y_mag,q_0,p_0,R_p,R_q,sigma_y,Lambda,Indices,sigma_lin,N_m,xl,xu,yl,yu,zl,zu)
