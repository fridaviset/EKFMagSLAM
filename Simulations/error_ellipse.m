...
% The code in this function is downloaded from
% 'https://nl.mathworks.com/matlabcentral/fileexchange/4705-error_ellipse'
% on the 23rd of February 2022 and modified to plot black error ellipsoids 
...
default_properties = struct(...
  ...
  'conf', 0.6827, ... % Percent confidence/100, corresponds to 1 std
...
if r==3 & c==3
  ...
  linewidth=1.2;
  h1=plot3(x0+k*x,y0+k*y,z0+k*z,prop.style,'linewidth',linewidth);hold on
  [y,z,x] = getpoints(Cyz,prop.clip);
  h2=plot3(x0+k*x,y0+k*y,z0+k*z,prop.style,'linewidth',linewidth);hold on
  [z,x,y] = getpoints(Czx,prop.clip);
  h3=plot3(x0+k*x,y0+k*y,z0+k*z,prop.style,'linewidth',linewidth);hold on
